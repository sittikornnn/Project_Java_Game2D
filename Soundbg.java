...
public void soundgamewin(){
		AudioInputStream audioStream = null;
			try {
				File file = new File("gamewin.wav");
				audioStream = AudioSystem.getAudioInputStream(file);
				Clip clip = AudioSystem.getClip();
...
public void soundkillAlien(){
		AudioInputStream audioStream = null;
			try {
				File file = new File("Alienbreak.wav");
				audioStream = AudioSystem.getAudioInputStream(file);
				Clip clip = AudioSystem.getClip();
...
public void sounddownHP(){
		AudioInputStream audioStream = null;
			try {
				File file = new File("hitPlayer.wav");
				audioStream = AudioSystem.getAudioInputStream(file);
				Clip clip = AudioSystem.getClip();
